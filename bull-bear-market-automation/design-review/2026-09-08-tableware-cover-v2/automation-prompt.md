...
- 같은 기준일에 `output/YYYY-MM-DD/bull/`과 `output/YYYY-MM-DD/bear/`를 각각 만든다.
- 각 폴더에는 PNG 7장과 `caption.md`, `reels-script.md`, `story-copy.md`만 최종 보관한다.
- `bull`은 강세 테마 5개와 황소만, `bear`는 약세 테마 5개와 곰만 사용한다.
- 두 패키지는 같은 테마군, 가격 기준, 산식, 기준 시각을 사용한다.
